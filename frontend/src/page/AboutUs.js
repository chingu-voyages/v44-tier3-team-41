									...
									<div class="flex flex-wrap">
										...
										<div class="w-full shrink-0 grow-0 basis-auto lg:w-7/12">
											<div class="mx-auto grid max-w-7xl gap-x-8 gap-y-20 px-6">
												...
												<div class="grid gap-x-4 gap-y-4 sm:grid-cols-3 xl:col-span-3">
													{People.map(
														person => (
															<div
																key={
																...
																className="ml-2 grow">
																<h4 className="mb-1 font-medium text-base text-dark2">
																	{person.name}
																</h4>
												...
												<div class="w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:px-6">
													<div class="align-start flex">
														<div class="ml-2 grow text-dark5 text-xs whitespace-nowrap">

															<a class="text-dark5 text-base font-bold" href='https://github.com/chingu-voyages/v44-tier3-team-41'>
																Visit GitHub Repo
															</a>
