								...
								<section className="mb-8">
									...
									<div className="flex flex-wrap">
										...
										<div className="w-full md:w-10/12">
											<div className="mx-auto grid gap-x-4 gap-y-20 px-2">
												<div className="grid grid-cols-2 lg:grid-cols-3 ">
													{People.map((person) => (
														<div key={person.name} className="ml-2 grow mt-6">
															<h4 className="mb-1 font-medium text-lg text-dark2 whitespace-nowrap">
																{person.name}
															</h4>
															<div className="text-dark5 text-sm">
																<p>{person.role}</p>
																<p>{person.email}</p>
