	...
	if (mentors && mentees) {
		return (
			<div className="bg-[#fafafa] p-5 rounded-lg shadow-lg pt-10 border border-light4">
				...
				<div className="border-b border-b-gray-900/10 lg:border-t lg:border-t-gray-900/10 text-center md:text-left">
				...
				<div className="flex flex-wrap justify-between md:justify-center my-4 overflow-auto">
					<div className="md:px-8 md:w-auto">
						<BarChart
							title="Company Chart"
							data={companyGroup}
						/>
