...
function MentorCard({mentor}) {
	...
	return (
		<li className="col-span-1 flex flex-col rounded-lg bg-white text-center shadow-md hover:shadow-lg">
			<Link
				to={'/dashboard/mentor_detail'}
				state={mentor}>
				<div className="flex flex-1 flex-col p-3">
					<img
						className="mx-auto h-60 w-full flex-shrink-0 rounded-lg object-center object-cover overflow-hidden shadow-md"
